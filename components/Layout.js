...
export default function Layout({ children }) {
  return (
    <div>
      <div className="px-2 md:px-24 bg-dark text-light flex justify-between h-16 opacity-90 fixed w-full">
      ...
      {children}
      <div className="h-16 bg-dark text-light sticky bottom-0">Footer</div>
    </div>
  );
}
